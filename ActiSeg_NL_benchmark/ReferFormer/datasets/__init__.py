...
from .actionvos_clipid import build as build_actionvos_clipid
from .actionvos_ws import build as build_actionvos_ws
...
def build_dataset(dataset_file: str, image_set: str, args):
    ...
    if dataset_file == 'actionvos_clipid':
        return build_actionvos_clipid(image_set, args)
    if dataset_file == 'actionvos_ws':
        return build_actionvos_ws(image_set, args)

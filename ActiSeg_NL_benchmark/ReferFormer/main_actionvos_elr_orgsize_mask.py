...
from engine import train_one_epoch_elr_orgsize_mask as train_one_epoch, evaluate, evaluate_a2d#train_one_epoch_elr_orgsize_mask
...
def main(args):
    ...
    param_dicts = [
        {
            "params": [p for n, p in model_without_ddp.named_parameters()
                       ...
                       not match_name_keywords(n, args.lr_text_encoder_names) and 
    ...
    if args.resume:
        ...
        if not args.eval and 'optimizer' in checkpoint and 'lr_scheduler' in checkpoint and 'epoch' in checkpoint:
            ...
            if args.override_resumed_lr_drop:
                print('Warning: args.override_resumed_lr_drop is set to True.')
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            args.clip_max_norm, args.start_epoch)  # Pass start_epoch
        lr_scheduler.step()
        if args.output_dir:
...
if __name__ == '__main__':
    ...
    args.dataset_file = 'actionvos_clipid'
    if args.all_pos:

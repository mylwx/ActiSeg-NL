...
from engine import train_one_epoch_ws as train_one_epoch, evaluate, evaluate_a2d
...
def main(args):
    ...
    data_loader_train = DataLoader(dataset_train, batch_sampler=batch_sampler_train,
                                   collate_fn=utils.collate_fn_npn, num_workers=args.num_workers)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            args.clip_max_norm,
            warmup_epochs=args.warmup_epochs_npn,)
        lr_scheduler.step()
        if args.output_dir:
...
if __name__ == '__main__':
    ...
    if args.dataset_ws:
        args.dataset_file = 'actionvos_ws'
    if args.output_dir:
        Path(args.output_dir).mkdir(parents=True, exist_ok=True)
    main(args)

#### npn mask script
# bash scripts/train_actionvos_npn_orgsize_mask.sh actionvos_dirs/name60_21by21/npn_noweights_orgsize_mask/ps4_2_0315 
# pretrained_weights/r101_refytvos_joint.pth 2 0,1  29000  --backbone resnet101 --expression_file train_meta_expressions_promptaction.json  
#  --use_positive_cls --actionvos_path ../dataset_visor_1122_latest_0119  --epochs 10  --lr_drop 3 5 7 --save_interval 1 --num_workers 6
#   --use_npn_loss_mask     --index_map_path  actionvos_dirs/name60_21by21/npn_noweights_orgsize_mask/ps4_2_0315/video_index_map.json
#   --sample_map_path actionvos_dirs/name60_21by21/npn_noweights_orgsize_mask/ps4_2_0315/clip_sample_map.json  --dataset_file  actionvos_ws

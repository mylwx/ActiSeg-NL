...
- meta_expressions
    ...
    - valid
        meta_expressions.json
"""
dir_root = "E:/1030/ReferFormer/"
def read_split_set(data_root=dir_root + 'data/ref-davis'):
...
def mv_images_to_folder(data_root=dir_root + 'data/ref-davis', output_root=dir_root + 'data/ref-davis'):
...
def create_meta_expressions(data_root=dir_root + 'data/ref-davis', output_root=dir_root + 'data/ref-davis'):
    """
...
def create_meta_annotaions(data_root=dir_root + 'data/ref-davis', output_root=dir_root + 'data/ref-davis'):
    """
...
if __name__ == '__main__':
    data_root = dir_root + "data/ref-davis"
    output_root = dir_root + "data/ref-davis"
